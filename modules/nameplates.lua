local Eavu = CreateFrame("Frame", nil, UIParent)
Eavu:SetScript("OnEvent", function(self, event, ...) self[event](self, ...) end)
...
Eavu:SetScript("OnUpdate", OnUpdate)

Eavu:RegisterEvent("PLAYER_REGEN_ENABLED")
function Eavu:PLAYER_REGEN_ENABLED()
	SetCVar("nameplateShowEnemies", 0)
end

Eavu:RegisterEvent("PLAYER_REGEN_DISABLED")
