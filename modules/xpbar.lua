...
function mXP:Set(ind, per)
  ind:ClearAllPoints()
  ind:SetPoint("TOPLEFT", UIParent:GetWidth()-10*per, 0)
end
...
local function Initialize()
  ...
  if not eXPRightTR then
    ...
    local bw = UIParent:GetWidth()-10/2
    -- right 'bracket'
    ...
    grad_panel ("eXPRightR",0,0,2,20-4,eXPRightTR,"TOPLEFT","TOPRIGHT",mXP,
    ...
    grad_panel ("eXPLeftL",0,0,2,20-4,eXPLeftTL,"TOPRIGHT","TOPLEFT",mXP,
          def_back,def_border,"BACKGROUND",col_br,no_col, "HORIZONTAL", col_br, col_br)
...
--[[    -- pixel overlay
    ...
    grad_panel ("eXPRightOR",0,0,1,20-4,eXPRightOTR,"TOPLEFT","TOPRIGHT",mXP,
    ...
    grad_panel ("eXPLeftOL",0,0,1,20-4,eXPLeftOTL,"TOPRIGHT","TOPLEFT",mXP,
          def_back,def_border,"BACKGROUND",{1,1,1,1},no_col, "HORIZONTAL", {1,1,1,1}, {1,1,1,1})
...
function mXP:ApplyDimensions()
  mXP:SetWidth(UIParent:GetWidth()-10)
  mXP:SetHeight(20)
  indMain:SetHeight(20)
  ind1:SetHeight(20/3)
  ind2:SetHeight(20/3)
end
...
mXP:SetScript("OnEvent", function(self, event, ...)
  ...
  if event == "PLAYER_ENTERING_WORLD" then
    ...
    if swidth < 1500 and cfg.modules.xp_bar.auto_adjust then
      UIParent:GetWidth()-10 = swidth-860
    end
    Initialize()
    mXP:ApplyDimensions()
  end
